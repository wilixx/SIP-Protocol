...
class packet:
    ...
    def __init__(self, code, sender_name, domain, protocol, port, sender_network_name, receiver_network_name, receiver_name, seq_num, subject, content_type, content_sub_type, tag='123'):
        self.__make_packet(code, sender_name, domain, protocol, port, sender_network_name, receiver_network_name, receiver_name, seq_num, subject, content_type, content_sub_type, tag)
    ...
    def __make_packet(self, sender_name, sender_network_name, receiver_network_name, receiver_name, protocol, domain, port, seq_num, request_type, subject, content_type, content_sub_type, tag):
